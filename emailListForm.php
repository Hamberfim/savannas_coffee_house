        ...
        <div class="container" id="content">
            <div class="row">
                <div class="col-sm">
                    ...
                    <h5 class="voltage_reg"> Acts Notification List</h5>
                    <!-- PHP CODE -->
                    <?php

echo "<p>Thank you for your response. We will add you to the Acts Notification List.</p>";
...
//          CHANGE THE FOLLOWING INFORMATION TO SEND EMAIL FOR YOU //  
	...
	$subject = "Add me to Savanna's Acts Notification List";	//CHANGE within the quotes. Place your own message.  For the assignment use "WDV101 Email Example" 
